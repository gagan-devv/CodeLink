 ...
 */
export type PayloadFor<T extends MessageType> = T extends 'HANDSHAKE'
  ? HandshakePayload
  : T extends 'HANDSHAKE_ACK'
    ? HandshakeAckPayload
    : T extends 'PING'
      ? PingPayload
      : T extends 'PONG'
        ? PongPayload
        : T extends 'SESSION_REVOKED'
          ? SessionRevokedPayload
          : T extends 'FILE_SNAPSHOT'
            ? FileSnapshotPayload
            : T extends 'FILE_PATCH'
              ? FilePatchPayload
              : T extends 'EDITOR_FOCUS'
                ? EditorFocusPayload
                : T extends 'PATCH_ACK'
                  ? PatchAckPayload
                  : T extends 'SNAPSHOT_REQUEST'
                    ? SnapshotRequestPayload
                    : T extends 'INJECT_PROMPT'
                      ? InjectPromptPayload
                      : T extends 'PROMPT_RESPONSE'
