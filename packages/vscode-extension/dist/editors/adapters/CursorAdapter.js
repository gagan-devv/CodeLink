...
class CursorAdapter {
    ...
    async detect() {
        try {
            ...
            const cursorCommands = commands.filter((cmd) => cmd.startsWith('cursor.') || cmd.toLowerCase().includes('cursor'));
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    return {
                        success: false,
                        error: `Failed to inject prompt into Cursor: ${primaryErrorMessage}. ` +
