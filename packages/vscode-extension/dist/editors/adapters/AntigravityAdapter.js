...
class AntigravityAdapter {
    constructor() {
        this.editorId = 'antigravity';
        this.editorName = 'Antigravity';
        this.capabilities = {
    ...
    async detect() {
        try {
            ...
            const antigravityCommands = commands.filter((cmd) => cmd.startsWith('antigravity.') || cmd.toLowerCase().includes('antigravity'));
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    return {
                        success: false,
                        error: `Failed to inject prompt into Antigravity: ${primaryErrorMessage}. ` +
