 ...
 */
export declare enum EditorAdapterErrorType {
 ...
 */
export declare function safeExecuteCommand(command: string, ...args: unknown[]): Promise<PromptInjectionResult>;
/**
 ...
 */
export declare function requireCapability(adapter: IEditorAdapter, capability: keyof IEditorAdapter['capabilities'], operationName: string): void;
/**
 ...
 */
export declare function requireMethod(adapter: IEditorAdapter, methodName: keyof IEditorAdapter, capability: keyof IEditorAdapter['capabilities']): void;
/**
 ...
 */
export declare function formatAdapterError(adapter: IEditorAdapter, operation: string, error: unknown): string;
/**
 ...
 */
export declare function createAdapterError(errorType: EditorAdapterErrorType, message: string, details?: unknown): EditorAdapterError;
/**
 ...
 */
export declare function executeWithCapabilityCheck<T>(adapter: IEditorAdapter, capability: keyof IEditorAdapter['capabilities'], operationName: string, operation: () => Promise<T>): Promise<T>;
