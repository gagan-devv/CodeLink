...
exports.default = (0, config_1.defineConfig)({
    ...
    resolve: {
        alias: {
            '@codelink/protocol': path_1.default.resolve(__dirname, './packages/protocol/src'),
            // Alias react-native to our mock for testing
            'react-native': path_1.default.resolve(__dirname, './tests/setup/react-native-mock.ts'),
